...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url()?>assets/template/assets/css/pages/error.css">
...
<div class="error-page container">
    <div class="col-md-8 col-12 offset-md-2">
        <div class="text-center">
            <img class="img-error" src="<?= base_url()?>assets/template/assets/images/samples/error-404.svg" alt="Not Found">
